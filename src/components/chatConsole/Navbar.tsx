    ...
    <div className="dark:bg-[#282828] bg-[#F6F5F2] absolute  h-14 z-10 w-full top-0 flex items-center ps-5 justify-between">
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger>
            {
              isDark? (<svg onClick={()=>setIsDark(false)} width="30" height="30" id="light-icon"> <circle cx="15" cy="15" r="6" fill="currentColor" /> <line id="ray" stroke="currentColor" strokeWidth="2" strokeLinecap="round" x1="15" y1="1" x2="15" y2="4" ></line> <use href="#ray" transform="rotate(45 15 15)" /> <use href="#ray" transform="rotate(90 15 15)" /> <use href="#ray" transform="rotate(135 15 15)" /> <use href="#ray" transform="rotate(180 15 15)" /> <use href="#ray" transform="rotate(225 15 15)" /> <use href="#ray" transform="rotate(270 15 15)" /> <use href="#ray" transform="rotate(315 15 15)" /> </svg>)
              :(<svg onClick={()=>setIsDark(true)} width="30" height="30" id="dark-icon"> <path fill="currentColor" d=" M 23, 5 A 12 12 0 1 0 23, 25 A 12 12 0 0 1 23, 5" /> </svg>)
            } 
            </TooltipTrigger>
            <TooltipContent>
              {
