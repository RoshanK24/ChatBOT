...
import { gotoSignUp, login } from "./action"
    ...
    return (
        ...
        <main className="h-screen w-screen flex justify-center items-center dark:bg-[#141414]">
          <div className="h-fit w-96 flex flex-col items-center gap-8">
            <div className="text-4xl font-semibold font-sans flex flex-col items-center gap-8">
            ...
            <Tabs value="signin" className="w-[400px]">
              <TabsList className="w-full">
                <TabsTrigger value="account" className="w-full" onClick={handleSignUpClick}>Sign Up</TabsTrigger>
                <TabsTrigger value="signin" className="w-full">Sign In</TabsTrigger>
              </TabsList>
              <TabsContent value="signin">
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 flex flex-col w-full mb-10">
                    <FormField
                    ...
                    /> 
                    <Button type="submit" className="mx-1 h-10">Sign In</Button>
                  </form>
                </Form>
              </TabsContent> 
            </Tabs>
