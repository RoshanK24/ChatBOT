...
const Login = () => {
  ...
  async function insertUser(username: string, email: string): Promise<void> {
    try {  
      const data1 = await supabase.auth.getUser();
      const id =data1.data.user?.id;
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Write your email" {...field} className="h-11 border-gray-700"/>
                          </FormControl> 
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Write your Password" {...field} className="h-11 border-gray-700"/>
                          </FormControl> 
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Write your Name" {...field} className="h-11 border-gray-700"/>
                          </FormControl> 
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    <Button type="submit" className="mx-1 h-10">Sign Up</Button>
                  </form>
                </Form>
              </TabsContent> 
            </Tabs>
